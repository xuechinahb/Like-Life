...
var DES3 = {
    ...
    APPKEY:function(){
        ...
        d = new Date();
        var result = this.encrypt("liuyunqiang@lx100$#365#$","LLSECRETKEY" + d.yyyymmdd() + "LL");
        return result;
        // var genKey = genkey("liuyunqiang@lx100$#365#$", 0, 24);
        // return btoa(des(genKey.key, "LLSECRETKEY" + d.yyyymmdd() + "LL", 1, 1, des3iv, 1));
    }
